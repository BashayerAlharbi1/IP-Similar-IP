...
wcss=[]
for i in range(1,10): #tries to clustere the data using different value of k, starting from k=1 to k=10.
...
print (frame['Clusters'].value_counts()) # Print the size of each cluster  
...
#---------------------------------------------------------------------------------------------------------#
################################# Mapping the IP along with the Featuers  #################################
#---------------------------------------------------------------------------------------------------------#
...
data_with_clusters.insert(0,'S_IP', data_raw.loc[:,'srcaddr']) #first columns is zeros
